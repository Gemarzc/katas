...
console.log('Precio actualizado globalBasePrice:', globalBasePrice)
console.log('Precio final car1:', car1.finalPrice)
console.log('Precio final car2:', car2.finalPrice)
